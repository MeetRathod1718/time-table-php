...
<div class="col-md-5" align="center">
        ...
        <input type="submit" value="Login " name="save" style="background-color:#000" size=18/>
        
		<h1 style="padding-top:20px"><a href="../index.php">
            <font color="#000" size="+18">Home</font></a></h1>
      </form>
            </div>
        </div>
    </header>
